...
module mkCICInterpolationFilter_64_4_3_8_8(CLK,
					   RST_N,
  ...
  reg [35 : 0] ifc_ddly_0_0;
  wire [35 : 0] ifc_ddly_0_0$D_IN;
  wire ifc_ddly_0_0$EN;

  // register ifc_ddly_0_1
  reg [35 : 0] ifc_ddly_0_1;
  wire [35 : 0] ifc_ddly_0_1$D_IN;
  wire ifc_ddly_0_1$EN;

  // register ifc_ddly_1_0
  reg [35 : 0] ifc_ddly_1_0;
  wire [35 : 0] ifc_ddly_1_0$D_IN;
  wire ifc_ddly_1_0$EN;

  // register ifc_ddly_1_1
  reg [35 : 0] ifc_ddly_1_1;
  wire [35 : 0] ifc_ddly_1_1$D_IN;
  wire ifc_ddly_1_1$EN;

  // register ifc_ddly_2_0
  reg [35 : 0] ifc_ddly_2_0;
  wire [35 : 0] ifc_ddly_2_0$D_IN;
  wire ifc_ddly_2_0$EN;

  // register ifc_ddly_2_1
  reg [35 : 0] ifc_ddly_2_1;
  wire [35 : 0] ifc_ddly_2_1$D_IN;
  wire ifc_ddly_2_1$EN;

  // register ifc_ddly_3_0
  reg [35 : 0] ifc_ddly_3_0;
  wire [35 : 0] ifc_ddly_3_0$D_IN;
  wire ifc_ddly_3_0$EN;

  // register ifc_ddly_3_1
  reg [35 : 0] ifc_ddly_3_1;
  wire [35 : 0] ifc_ddly_3_1$D_IN;
  wire ifc_ddly_3_1$EN;

  // register ifc_dstg_0
  reg [35 : 0] ifc_dstg_0;
  wire [35 : 0] ifc_dstg_0$D_IN;
  wire ifc_dstg_0$EN;

  // register ifc_dstg_1
  reg [35 : 0] ifc_dstg_1;
  wire [35 : 0] ifc_dstg_1$D_IN;
  wire ifc_dstg_1$EN;

  // register ifc_dstg_2
  reg [35 : 0] ifc_dstg_2;
  wire [35 : 0] ifc_dstg_2$D_IN;
  wire ifc_dstg_2$EN;

  // register ifc_dstg_3
  reg [35 : 0] ifc_dstg_3;
  wire [35 : 0] ifc_dstg_3$D_IN;
  wire ifc_dstg_3$EN;

  // register ifc_istg_0
  reg [35 : 0] ifc_istg_0;
  wire [35 : 0] ifc_istg_0$D_IN;
  wire ifc_istg_0$EN;

  // register ifc_istg_1
  reg [35 : 0] ifc_istg_1;
  wire [35 : 0] ifc_istg_1$D_IN;
  wire ifc_istg_1$EN;

  // register ifc_istg_2
  reg [35 : 0] ifc_istg_2;
  wire [35 : 0] ifc_istg_2$D_IN;
  wire ifc_istg_2$EN;

  // register ifc_istg_3
  reg [35 : 0] ifc_istg_3;
  wire [35 : 0] ifc_istg_3$D_IN;
  wire ifc_istg_3$EN;
  ...
  // actionvalue method response_get
  assign response_get = x__h3830[35:28] ;
  assign RDY_response_get = 1'd1 ;

  // inlined wires
  assign ifc_wr_x$wget = { {28{request_put[7]}}, request_put } ;

  // register ifc_count
  assign ifc_count$D_IN = (ifc_count == 6'd63) ? 6'd0 : x__h3767 ;
  ...
  // register ifc_dstg_3
  assign ifc_dstg_3$D_IN = ifc_dstg_2 - ifc_ddly_3_1 ;
  assign ifc_dstg_3$EN = EN_request_put ;

  // register ifc_istg_0
  assign ifc_istg_0$D_IN = ifc_istg_0 + ifc_dstg_3 ;
  ...
  // remaining internal signals
  assign x__h3767 = ifc_count + 6'd1 ;
  assign x__h3830 =
	     ifc_istg_3 + (ifc_istg_3[28] ? 36'd134217728 : 36'd134217727) ;
  ...
  begin
	...
	ifc_ddly_0_0 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_ddly_0_1 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_ddly_1_0 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_ddly_1_1 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_ddly_2_0 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_ddly_2_1 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_ddly_3_0 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_ddly_3_1 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_dstg_0 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_dstg_1 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_dstg_2 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_dstg_3 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_istg_0 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_istg_1 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_istg_2 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	ifc_istg_3 <= `BSV_ASSIGNMENT_DELAY 36'd0;
      end
    else
      begin
  ...
  begin
    ifc_count = 6'h2A;
    ifc_ddly_0_0 = 36'hAAAAAAAAA;
    ifc_ddly_0_1 = 36'hAAAAAAAAA;
    ifc_ddly_1_0 = 36'hAAAAAAAAA;
    ifc_ddly_1_1 = 36'hAAAAAAAAA;
    ifc_ddly_2_0 = 36'hAAAAAAAAA;
    ifc_ddly_2_1 = 36'hAAAAAAAAA;
    ifc_ddly_3_0 = 36'hAAAAAAAAA;
    ifc_ddly_3_1 = 36'hAAAAAAAAA;
    ifc_dstg_0 = 36'hAAAAAAAAA;
    ifc_dstg_1 = 36'hAAAAAAAAA;
    ifc_dstg_2 = 36'hAAAAAAAAA;
    ifc_dstg_3 = 36'hAAAAAAAAA;
    ifc_istg_0 = 36'hAAAAAAAAA;
    ifc_istg_1 = 36'hAAAAAAAAA;
    ifc_istg_2 = 36'hAAAAAAAAA;
    ifc_istg_3 = 36'hAAAAAAAAA;
  end
  `endif // BSV_NO_INITIAL_BLOCKS
  // synopsys translate_on
endmodule  // mkCICInterpolationFilter_64_4_3_8_8
