...
module mkCICInterpolationFilter_64_4_2_28_8_8(CLK,
  ...
  reg [11 : 0] ifc_ddly_0_0;
  wire [11 : 0] ifc_ddly_0_0$D_IN;
  wire ifc_ddly_0_0$EN;

  // register ifc_ddly_0_1
  reg [11 : 0] ifc_ddly_0_1;
  wire [11 : 0] ifc_ddly_0_1$D_IN;
  wire ifc_ddly_0_1$EN;

  // register ifc_ddly_1_0
  reg [11 : 0] ifc_ddly_1_0;
  wire [11 : 0] ifc_ddly_1_0$D_IN;
  wire ifc_ddly_1_0$EN;

  // register ifc_ddly_1_1
  reg [11 : 0] ifc_ddly_1_1;
  wire [11 : 0] ifc_ddly_1_1$D_IN;
  wire ifc_ddly_1_1$EN;

  // register ifc_ddly_2_0
  reg [11 : 0] ifc_ddly_2_0;
  wire [11 : 0] ifc_ddly_2_0$D_IN;
  wire ifc_ddly_2_0$EN;

  // register ifc_ddly_2_1
  reg [11 : 0] ifc_ddly_2_1;
  wire [11 : 0] ifc_ddly_2_1$D_IN;
  wire ifc_ddly_2_1$EN;

  // register ifc_ddly_3_0
  reg [11 : 0] ifc_ddly_3_0;
  wire [11 : 0] ifc_ddly_3_0$D_IN;
  wire ifc_ddly_3_0$EN;

  // register ifc_ddly_3_1
  reg [11 : 0] ifc_ddly_3_1;
  wire [11 : 0] ifc_ddly_3_1$D_IN;
  wire ifc_ddly_3_1$EN;

  // register ifc_dstg_0
  reg [11 : 0] ifc_dstg_0;
  wire [11 : 0] ifc_dstg_0$D_IN;
  wire ifc_dstg_0$EN;

  // register ifc_dstg_1
  reg [11 : 0] ifc_dstg_1;
  wire [11 : 0] ifc_dstg_1$D_IN;
  wire ifc_dstg_1$EN;

  // register ifc_dstg_2
  reg [11 : 0] ifc_dstg_2;
  wire [11 : 0] ifc_dstg_2$D_IN;
  wire ifc_dstg_2$EN;

  // register ifc_dstg_3
  reg [11 : 0] ifc_dstg_3;
  wire [11 : 0] ifc_dstg_3$D_IN;
  wire ifc_dstg_3$EN;
  ...
  // actionvalue method response_get
  assign response_get = x__h3838[35:28] ;
  assign RDY_response_get = 1'd1 ;

  // inlined wires
  assign ifc_wr_x$wget = { {4{request_put[7]}}, request_put } ;

  // register ifc_count
  assign ifc_count$D_IN = (ifc_count == 6'd63) ? 6'd0 : x__h3775 ;
  ...
  // register ifc_istg_0
  assign ifc_istg_0$D_IN = ifc_istg_0 + { {24{ifc_dstg_3[11]}}, ifc_dstg_3 } ;
  ...
  // remaining internal signals
  assign x__h3775 = ifc_count + 6'd1 ;
  assign x__h3838 =
  ...
  begin
	...
	ifc_ddly_0_0 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_ddly_0_1 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_ddly_1_0 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_ddly_1_1 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_ddly_2_0 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_ddly_2_1 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_ddly_3_0 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_ddly_3_1 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_dstg_0 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_dstg_1 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_dstg_2 <= `BSV_ASSIGNMENT_DELAY 12'd0;
	ifc_dstg_3 <= `BSV_ASSIGNMENT_DELAY 12'd0;
  ...
  begin
    ifc_count = 6'h2A;
    ifc_ddly_0_0 = 12'hAAA;
    ifc_ddly_0_1 = 12'hAAA;
    ifc_ddly_1_0 = 12'hAAA;
    ifc_ddly_1_1 = 12'hAAA;
    ifc_ddly_2_0 = 12'hAAA;
    ifc_ddly_2_1 = 12'hAAA;
    ifc_ddly_3_0 = 12'hAAA;
    ifc_ddly_3_1 = 12'hAAA;
    ifc_dstg_0 = 12'hAAA;
    ifc_dstg_1 = 12'hAAA;
    ifc_dstg_2 = 12'hAAA;
    ifc_dstg_3 = 12'hAAA;
